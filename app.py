...
def load_pickle_files():
    if not os.path.exists("movie_list.pkl"):
        gdown.download(
            "https://drive.google.com/file/d/1Lh9cEopyWpNCcoilduEgiu6y_5YTSxyr/view?usp=drive_link",
            "movie_list.pkl",
            quiet=False
        )
    ...
    if not os.path.exists("similarity.pkl"):
        gdown.download(
            "https://drive.google.com/file/d/1L6koy5JukBaq53nc1qWekz_1-MJuf6Gn/view?usp=drive_link",
            "similarity.pkl",
            quiet=False
        )
